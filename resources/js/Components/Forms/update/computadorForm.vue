<template>
    <div>
        ...
        >
            <option disabled value="">Selecione o Computador</option>
            <option v-for="item in Computador" :key="item.id" :value="item.id">
                {{ item.name }}
            </option>
        </select>
        ...
        >
            Preço atual:
            {{ Computador.find((item) => item.id === form.id).price }}€
        </label>
        ...
        <label
            ...
            >Stock atual:
            {{ Computador.find((item) => item.id === form.id).stock }}
            Unidades</label
        >
